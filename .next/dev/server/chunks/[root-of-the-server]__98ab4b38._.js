...
"[project]/app/api/posts/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        const post = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].post.findUnique({
            where: {
                id
            },
            include: {
...
async function DELETE(req, { params }) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].post.delete({
            where: {
                id
            }
        });
...
async function PATCH(req, { params }) {
    try {
        ...
        const updatedPost = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].post.update({
            where: {
                id
            },
            data: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedPost);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__98ab4b38._.js.map