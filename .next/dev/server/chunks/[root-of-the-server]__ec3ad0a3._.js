...
"[project]/app/api/reactions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    try {
        ...
        if (!postId || !type) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("Missing fields", {
                status: 400
            });
        }
        ...
        // So we should upsert.
        const reaction = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].reaction.upsert({
            where: {
                postId_userId: {
                    postId,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(reaction);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ec3ad0a3._.js.map