...
export function PostCard({ post, currentUserId }: PostCardProps) {
    ...
    return (
        <Card className="overflow-hidden hover:shadow-md transition-shadow">
            ...
            <CardFooter className="p-3 md:p-4 pt-0 flex gap-2 md:gap-4 flex-wrap items-center">
                {/* Reaction buttons - now includes thumbs up */}
                <div className="flex items-center gap-1">
                    ...
                    >
                        ...
                        <span className="font-bold">{optimisticReactions}</span>
                    </Button>
